...
//   1st delete function keyword, add arrow after argument list 
//  remove the namae and make the function anonymous. How do we call it now?
//  We will assign the arrow function INTO a variable  
...
//   return course.CourseId == "PROG200"; 
 ...
 let isProg200course = courses.find((course) => course.CourseId == "PROG200") ; 

 console.log(isProg200course.StartDate);
...
//  after : 
 let proj500CourseTitle = (course) => course.CourseId === "PROJ500";
  
console.log(proj500CourseTitle.Title )
